...
test("World#addComponent()", t => {
  ...
  const addedEvents = world.createEventChannel(
...
test("World#getImmutableComponent()", t => {
  ...
  const changedEvents = world.createEventChannel(
  ...
  t.is(
    world.getImmutableComponent(entityId, TestComponent).value,
    component.value
  );
  ...
  t.throws(() => {
    const immutableComponent = world.getImmutableComponent(
      entityId,
      TestComponent
    );
...
test("World#removeComponent()", t => {
  ...
  const removedEvents = world.createEventChannel(
